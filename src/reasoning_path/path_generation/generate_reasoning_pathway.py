...
DEFAULT_DEVICE = "cuda"
DEFAULT_SAE_ROOT = Path(os.environ.get("BT4_SAE_ROOT", PROJECT_ROOT / "result_BT4"))
DEFAULT_TC_ROOT = DEFAULT_SAE_ROOT / "tc" / "k_30_e_16"
DEFAULT_LORSA_ROOT = DEFAULT_SAE_ROOT / "lorsa" / "k_30_e_16"
