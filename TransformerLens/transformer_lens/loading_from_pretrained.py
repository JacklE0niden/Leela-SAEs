...
def convert_hf_model_config(model_name: str, **kwargs):
    ...
    if "llama" in official_model_name.lower():
        ...
        raise ValueError(f"Model {official_model_name} not supported")
...
def convert_lc0_model_config(model_name: str):
    if model_name == "lc0/T82-768x15x24h":
        return {
            ...
            "eps": 1e-05,
            "act_fn": "silu",
            "is_leela_chess_model": True,
            "gated_mlp": False,
            "attention_dir": "bidirectional",
            "tokenizer_name": "lc0-T82",
            "d_vocab": 1858,
            "leela_embed":"normal",
            "leela_mlp_act_fn": "squaredrelu",
            "leela_resid_alpha": "pre",
            "d_value_head": 32,
            "d_mlh_head": 8,
        }
    elif model_name == "lc0/BT4-1024x15x32h":
        return {
            "d_model": 1024,
            "d_head": 1024 // 32,
            "n_heads": 32,
            ...
            "gated_mlp": False,
            "attention_dir": "bidirectional",
            "tokenizer_name": "lc0-BT4",
            "d_vocab": 1858,
            "leela_embed":"advanced",
            "leela_mlp_act_fn": "mish",
            "leela_resid_alpha": "post",
            "d_value_head": 128,
            "d_mlh_head": 32,
        }
    ...
    **kwargs,
    ...
    if (
        ...
        if cfg.from_checkpoint:
            ...
            elif "chameleon" in official_model_name:
